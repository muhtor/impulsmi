...
import Partner_5 from './Partners/Partner_5';
import Partner_6 from './Partners/Partner_6';
      ...
      <>
        <AnimatePresence>
          <Routes location={location} key={location.pathname}>
            ...
            <Route path="/partner_1" element={<Partner_1 />} />
            <Route path="/partner_2" element={<Partner_2 />} />
            <Route path="/partner_3" element={<Partner_3 />} />
            <Route path="/partner_4" element={<Partner_4 />} />
            <Route path="/partner_5" element={<Partner_5 />} />
            <Route path="/partner_6" element={<Partner_6 />} />
          </Routes>
        </AnimatePresence>
      </>
    );
